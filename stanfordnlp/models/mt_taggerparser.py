...
def parse_args():
    ...
    parser.add_argument('--num_layers', type=int, default=3)  # 3 from parser (2 for tagger)
    ...
    parser.add_argument('--no_linearization', dest='linearization', action='store_false', help="Turn off linearization term.")  # TODO from parser
    parser.add_argument('--no_distance', dest='distance', action='store_false', help="Turn off distance term.")  # TODO from parser
    parser.add_argument('--share_hid', action='store_true', help="Share hidden representations for UPOS, XPOS and UFeats.")  # TODO from tagger
    parser.set_defaults(share_hid=False)  # TODO from tagger
...
def train(args):
    ...
    model_file = args['save_dir'] + '/' + args['save_name'] if args['save_name'] is not None \
            else '{}/{}_mt_taggerparser.pt'.format(args['save_dir'], args['shorthand'])
